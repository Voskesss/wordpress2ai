  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      <h1 className="font-display text-4xl sm:text-5xl font-semibold tracking-tight">
        Je eigen AI en WordSwap: wat kan er al?
      </h1>
      <p className="mt-5 text-lg text-stone-600 leading-relaxed">
        ...
        hij bestaat uit gewone bestanden. De WordSwap-chat werkt nu al; een
        rechtstreekse koppeling met je eigen ChatGPT of Claude is nog gepland.
        Er zijn drie manieren om er met AI aan te werken — van makkelijk tot
        volledig zelfstandig. Geen lock-in: welke AI er ook komt, jouw site is
        er klaar voor.
      </p>
      ...
      <div className="mt-10 rounded-xl bg-violet-700 p-8 text-white">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
            href="/contact"
            className="rounded-full bg-white px-6 py-3 font-semibold text-violet-700"
          >
            Expert-toegang aanvragen
          </Link>
          <Link
            href="/demo"
            className="rounded-full border-2 border-violet-400 px-6 py-3 font-semibold text-white hover:border-white"
          >
