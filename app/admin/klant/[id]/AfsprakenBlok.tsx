            ...
            a.status === "bevestigd" ? (
              ...
              <div key={a.id} className="flex flex-wrap items-center gap-3 rounded-xl bg-amber-50 px-3 py-2 text-sm text-amber-900">
                ...
                <input
                  ...
                  className="w-56 rounded-lg border border-stone-300 px-2.5 py-1 text-xs focus:border-emerald-500 focus:outline-none"
                />
                <MailVoorbeeldKnop klein soort="afspraak-bevestiging" siteId={siteId} extra={{ afspraakId: String(a.id) }} velden={[["contact", "contact"], ["bericht", "bericht"], ["onderwerp", "onderwerp"]]} />
                  <ActieKnop
                    label="Bevestigen"
