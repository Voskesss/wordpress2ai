...
export async function POST(req: Request) {
  ...
  const [ns, mxRuw, txt, dmarc, aRoot, www, reg, ...subs] = await Promise.all([
    doh(domein, "NS"),
    doh(domein, "MX"),
    doh(domein, "TXT"),
...
Antwoord in maximaal 5 korte bullets (elk één zin, Nederlands, geen inleiding of afsluiting): wat valt op, welke route geldt hier, welke valkuil speelt bij déze klant, en welk aanbod (mail/doorsturen) logisch is.`,
