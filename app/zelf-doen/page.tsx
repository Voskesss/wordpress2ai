      ...
      <div className="mx-auto max-w-3xl px-6 pt-20 pb-4 sm:flex sm:items-center sm:gap-8">
        <div className="min-w-0">
          ...
          <p className="mt-5 text-lg text-stone-600 leading-relaxed">
            Alles wat wij doen, kun je in principe zelf. Hier staat precies hoe
            — zonder addertjes, inclusief de valkuilen waar wij zelf in zijn
            getrapt. Kom je er zelf uit: fantastisch. Kom je er halverwege
            achter dat je hier je tijd niet in wilt stoppen: dan weet je ons te
            vinden, en snap je meteen wat je bij ons afneemt.
          </p>
        </div>
      ...
      <div className="bg-[#f6f1e7] border-y border-stone-200">
        <div className="mx-auto max-w-3xl px-6 py-16">
          ...
          <p className="mt-4 text-stone-600 leading-relaxed">
            Reken op één tot meerdere dagen werk voor een kleine site, en op
            blijvend handwerk bij elke wijziging daarna. Ben je handig en vind
            je dit leuk: doen! Je site wordt er echt beter van, en dit
            stappenplan brengt je er.
          </p>
          <p className="mt-4 text-stone-600 leading-relaxed">
            Wat wij toevoegen zit vooral in de laatste stap: bij ons wijzig je
            je site daarna door het gewoon te typen — de AI voert het uit, jij
            keurt het goed. Dat kun je niet zelf nabouwen, en het is de reden
            dat onze klanten blijven. De overstap zelf doen we no cure, no pay:
            je ziet eerst de complete kopie, en alleen als je tevreden bent
            betaal je (vanaf €250).
          </p>
