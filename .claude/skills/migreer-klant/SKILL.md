...
- GELIJKVORMIGE PAGINA'S IN BULK (meer dan ±8 pagina's met dezelfde opbouw: nieuwsberichten, projecten, vacatures, kennisartikelen, portfolio-items): NOOIT stuk voor stuk met AI bouwen — dat is de grootste kostenpost van een migratie en het levert niets extra's op. Werkwijze: bouw éérst één pagina van die soort op de normale manier (bestek, screenshots, volle aandacht) als sjabloon; schrijf dan een omzetscript dat de overige pagina's uit de bronbestanden vult. KWALITEIT BLIJFT DE MAAT, het script is alleen de goedkopere weg ernaartoe: de volledige bouw-controle draait over álle omgezette pagina's, je legt een steekproef van minstens drie naast de oud-ontwerp-screenshots, en een pagina die van het stramien afwijkt bouw je gewoon met de hand. Meld in de oplevering hoeveel pagina's via het script gingen.
