...
export function maakOpvolgmail(
  ...
  const prijsRegel = prijs
    ? `Mocht je daarna willen overstappen: voor een site van jouw omvang is dat eenmalig ${prijs}, daarna vanaf €12 per maand voor hosting, beheer en de AI-chat.`
    : `Mocht je daarna willen overstappen: dat is eenmalig vanaf €150, daarna vanaf €12 per maand voor hosting, beheer en de AI-chat.`;
