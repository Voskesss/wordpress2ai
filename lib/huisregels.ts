...
- Formuliervelden: gewone contactgegevens (naam, e-mail, telefoon, adres, bericht, voorkeursdatum) zijn altijd prima. Vraag je om velden voor BSN, betaal- of bankgegevens, wachtwoorden, of medische/gezondheidsinformatie? Voeg die dan niet toe: leg de eigenaar vriendelijk uit dat zulke gegevens extra bescherming nodig hebben (privacywet) en dat WordPressToAI daar graag een passende, veilige oplossing voor opzet — verwijs daarvoor naar het contact met ons.`;
