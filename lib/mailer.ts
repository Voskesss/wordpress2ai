...
<tr><td style="border-top:3px solid #7c3aed;padding-top:16px">
<table role="presentation" cellpadding="0" cellspacing="0"><tr>
<td style="vertical-align:middle;padding-right:14px">
<img src="https://wordswap.nl/logo-mail.png" width="52" height="52" alt="WordSwap" style="display:block;border-radius:12px">
</td>
<td style="vertical-align:middle">
<p style="margin:0;font-size:16px;font-weight:700;color:#1c1917">Jos Klijnhout</p>
<p style="margin:2px 0 0;font-size:13px;color:#57534e"><span style="font-weight:700;color:#1c1917">W<span style="color:#7c3aed">ord</span>Swap</span> · websites zonder onderhoud</p>
