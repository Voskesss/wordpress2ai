...
<p>De kopie die wij maken kost vanaf €12 per maand, alles inbegrepen${p.prijs ? ` (de overstap zelf: eenmalig ${ontsnap(p.prijs)} voor jouw site)` : ""}, en aanpassen doe je zelf door het te typen. De kopie zelf maken we eerst gratis, zodat je kunt vergelijken zonder iets te beloven.</p>
...
De kopie die wij maken kost vanaf €12 per maand, alles inbegrepen (de overstap zelf: {{prijs}}), en aanpassen doe je zelf door het te typen. De kopie zelf maken we eerst gratis, zodat je kunt vergelijken zonder iets te beloven.
